...
const Footer = () => {
    return (
        <footer className="relative bg-blueGray-200 pt-8 pb-6 border-t-2 mt-5">
            <div className="container mx-auto px-3 lg:px-40">
                <div className="flex flex-wrap text-left lg:text-left">
                    <div className="w-full lg:w-6/12 px-4">
                        <h4 className="text-3xl fonat-semibold text-blueGray-700">Mixi Shop!</h4>
                ...
                <div className="flex flex-wrap items-center md:justify-between justify-center">
                    <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                        <div className="text-sm text-blueGray-500 font-semibold py-1">
                            Copyright © <span id="get-current-year">2024</span> Next 13 By <Link href={'https://facebook.com/xoxvp'}>NhonCQ</Link>
                        </div>
                    </div>
                </div>
            </div>
